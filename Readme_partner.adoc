...
After you submit your result sheets, the Cloudera team will review them against expected benchmarks and may ask you to re-run specific tests. Once results are satisfactory, the CDP setup is confirmed as validated on your hardware/environment.

For details on what happens after validation (technology blog, GTM, etc.), see the *IHV Partners* section.
